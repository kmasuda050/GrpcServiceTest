...
{
    public class IntegrationTestBase : IClassFixture<GrpcTestFixture>, IDisposable
    {
        ...
        public IntegrationTestBase(GrpcTestFixture fixture, ITestOutputHelper outputHelper)
        {
            Fixture = fixture;
